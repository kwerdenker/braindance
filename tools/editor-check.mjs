...
try {
  ...
  console.log('\n[10] a look leaves as a file and comes back as one');
  ...
  // ================================ 11. the pinned drive takes the loop away with it

  console.log('\n[11] pinning the drive drops what the loop was going to serve');
